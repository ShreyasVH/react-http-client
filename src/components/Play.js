...
export default class Play extends Component {
    constructor(props) {
        ...
        this.getUrl = 'http://localhost:9012/api?input=abc';
        this.postUrl = 'http://localhost:9012/api';
        this.putUrl = 'http://localhost:9012/api';
        this.deleteUrl = 'http://localhost:9012/api';
        this.payload = {
            a: 'A',
            b: 'B'
        };
